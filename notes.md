...
* Ferramentas utilizadas:
	...
	* [XAMPP](https://www.apachefriends.org/pt_br/index.html) – Pacote que inclui o Apache + MySQL/ MariaDB, PHP e o PHPmyAdmin. Permite criar um servidor em sua própria casa.
...
* Preparação e instalação:
	...
	* Instalação do WordPress no próprio computador:
		...
		* Para instalar o WordPress, acesse //localhost/cursowordpress/.
	...
	* Instalação do WordPress manualmente:
	...
	* Instalação de temas e plugins:
		...
		* Instale os seguintes plugins:
			...
			* [WPS Hide Login](https://br.wordpress.org/plugins/wps-hide-login/) - Modifica o caminho de login (wp-admin (http://localhost/cursowordpress/wp-admin/ ou https://www.cursowordpress/wp-admin/) e wp-login.php).
...
* Como escolher fontes para um site:
	* No mesmo documento de texto citado acima, com a proposta do site, contendo uma tabela das cores (cor e código hexadecimal) deverão ser informadas as fontes e qual o seu uso (título, destaques e conteúdo), também conforme a imagem acima.
